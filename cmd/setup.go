...
func init() {
	...
	setupCmd.Flags().BoolVar(&setupNoHashDiff, "no-hash-diff", false, "On expectChainHash drift, dump the full incoming content instead of a diff against the on-disk file")
...
func runSetup(_ *cobra.Command, _ []string) error {
	...
	if err := verifyChainHashes(layerMap, setupNoVerifyHash, !setupNoHashDiff); err != nil {
		return err
	}
