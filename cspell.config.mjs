...
export default defineConfig((config) => ({
  ...
  words: [
    ...
    "Chtimes",
    "statident",
    // The unified-results plans (docs/plans/2026-09-26-*.md): the Go packages
    // they introduce, the fingerprint prefix, the report and event vocabulary,
    // and the CI vendors, agents and tools they name.
    "cienv",
    "toolenv",
    "textpos",
    "gitutil",
    ...
    "dogfood",
    "qube",
    // British spellings the plans use next to "behaviour", which is already
    // listed above.
    "behaviourally",
    "colours",
    "defences",
