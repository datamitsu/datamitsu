...
var testedLeafCommands = map[string]string{
	...
	"lint":                         "TestExplainPlanGolden / TestExecutionTwoToolsPass / TestExecutionFailFastBetweenPriorities",
...
var detCases = []struct {
	...
	{name: "config-reconcile-preview", kind: detMinimal, args: []string{"config", "reconcile"}},
